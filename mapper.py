...
def coh_bpsk_mapper():
    '''
    This function maps the input bits to the corresponding BPSK symbols.
    '''
    print("not implemened")

def qbsk_mapper():
    '''
    This function maps the input bits to the corresponding QPSK symbols.
    '''
    print("not implemened")
