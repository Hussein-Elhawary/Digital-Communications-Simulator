...
plt.title("BER vs SNR for PSK Modulations")
plt.xlabel("SNR")
plt.ylabel("BER")
plt.semilogy(range(-2,11), ber_simulated_bpsk)
plt.semilogy(range(-2,11), ber_simulated_qpsk)
plt.semilogy(range(-2,11), ber_simulated_8_psk)
plt.semilogy(range(-2,11), ber_simulated_dpsk)
plt.legend(["BPSK", "QPSK", "8-PSK", "DPSK"])
plt.show()

plt.title("BER vs SNR for QAM Modulations")
plt.xlabel("SNR")
plt.ylabel("BER")
plt.semilogy(range(-2,11), ber_simulated_qam)
plt.semilogy(range(-2,11), ber_simulated_8_qam)
plt.semilogy(range(-2,11), ber_simulated_16_qam)
plt.legend(["QAM", "8-QAM", "16-QAM"])
plt.show()

plt.title("BER vs SNR for Modulations")
plt.xlabel("SNR")
plt.ylabel("BER")
plt.semilogy(range(-2,11), ber_simulated_bpsk)
plt.semilogy(range(-2,11), ber_simulated_qpsk)
...
plt.semilogy(range(-2,11), ber_simulated_bfsk)
plt.semilogy(range(-2,11), ber_simulated_dpsk)
plt.legend(["BPSK", "QPSK", "8-PSK", "OOK", "8-ASK", "QAM", "8-QAM", "16-QAM", "BFSK", "DPSK"])
plt.show()
